<?php
    ...
    $pdf->SetX(5);
    $sql = pg_query("select codigo,codigo_barras,descripcion,precio_minorista,precio_mayorista,stock,cantidad_minima from productos where stock::integer  <= cantidad_minima::integer  and estado = 'Si'");
