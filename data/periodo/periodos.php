...
if ($_POST['oper'] == "add") {
    ...
    // } else {
        $sql = "insert into periodo values ('$id','" . $_POST['fecha_periodo'] . "','" . $_POST['estado'] . "','$fecha')";
    ...
    if ($_POST['oper'] == "edit") {
        ...
        // } else {
            ...
            $sql = "update periodo set fecha_periodo = '" . $_POST['fecha_periodo'] . "', estado= '" . $_POST['estado'] . "', fecha_creacion = '$fecha' where id_periodo = '$_POST[id]'";
            $guardar = guardarSql($conexion, $sql);
